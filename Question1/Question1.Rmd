...
```
Insights from Figure \ref{Figure1}:
...
```{r, warning =  FALSE, fig.align = 'center', fig.cap = "Most Popular Baby Names per decade (1910-2014).\\label{Figure2}", fig.ext = 'png', fig.height = 20, fig.width = 10}

PopNamesMap <- popular_names_heatmap(decade_top_names)
PopNamesMap

```
Insights from Figure \ref{Figure2}:
