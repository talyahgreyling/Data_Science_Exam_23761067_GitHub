...
There are a total of xxxxx questions & each question has its own folder with an accompanying Readme, code and data folder.
...
I unzipped the data folder provided and put each file in its respective question folder.
