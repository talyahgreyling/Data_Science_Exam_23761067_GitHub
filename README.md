...
figures, tables, and write-ups for the exam. There are a total of xxxxx
...
```
    ...
    ## Ncells  555933 29.7    1237355 66.1   702048 37.5
    ## Vcells 1054941  8.1    8388608 64.0  1927558 14.8
...
I unzipped the data folder provided and put each file in its respective
question folder.
